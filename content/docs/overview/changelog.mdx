...
**Changes**
- **wallet-ton-gasless**: Added `verify` method to [`WalletAccountReadOnlyTonGasless`](../sdk/wallet-modules/wallet-ton-gasless/api-reference#walletaccountreadonlytongasless) ([v1.0.0-beta.4](https://github.com/tetherto/wdk-wallet-ton-gasfree/releases/tag/v1.0.0-beta.4))
...
- **indexer-api**: 
  - Added new [`/api/v1/chains`](../tools/indexer-api/api-reference) endpoint to list supported blockchains and tokens
