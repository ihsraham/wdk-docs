...
<Card title="WDK Bridge USD₮0 TON Protocol Configuration" href="./configuration">
Get started with WDK's Bridge USD₮0 TON Protocol configuration
</Card>
<Card title="WDK Bridge USD₮0 TON Protocol API" href="./api-reference">
Get started with WDK's Bridge USD₮0 TON Protocol API
</Card>
</Cards>
